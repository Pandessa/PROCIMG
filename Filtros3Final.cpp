...
void filtroMedia()
{
   ...
   imgResultado->Save("../figs/galeraMedia.png");
}
...
void filtroGauss()
{
   ...
   // Salva imagem alterada
   imgResultado->Save("../figs/galeraGauss.png");
}
...
void filtroSobel(int escolha)
{
  ...
  else if(img && escolha == 2)
  {
   ...
   if(escolha == 1)
     imgResultado->Save("../figs/brainF1.png");
   else if (escolha == 2)
     imgResultado->Save("../figs/brainF2.png");
}
...
int main(int argc, char *argv[])
{
   glutInit(&argc, argv);
   int escolha;
   cout << "Escolha um dos filtros abaixo:\n\n"<< "\t - Passa baixa:\n \t 1. Media\n\t 2. Gaussiana\n" << endl;
   cout << "\t - Passa alta:\n \t 3. Sobel\n\t 4. Prewit\n" << endl;
   cin >> escolha;
   ...
   //img->Read("../figs/lenaGray.png"); // prewit
   img->Read("../figs/brain.png");    // sobel
   //img->Read("../figs/galera2.png");   // gauss e media

   glutInitWindowSize(img->GetWidth(),img->GetHeight());
   glutInitDisplayMode(GLUT_RGB | GLUT_DOUBLE | GLUT_DEPTH);

   glutCreateWindow("ORIGINAL");
   glutPositionWindow (50, 30);
